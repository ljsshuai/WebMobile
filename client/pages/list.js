    ...
    render(){
        ...
        return(
            <div>
                ...
                <div className="user_main">
                    <div>
                        <ul className='list_one'>
                            <li>推荐人数:33</li>
                            <li>总计:320811</li>
                            <li><Button size="large" type="primary" style={{height:'22px',lineHeight:'22px',fontSize:'13px',margin:'0 auto'}} onClick={()=>{this.props.history.push("/bossreferee")}}>返还积分</Button></li>
                        </ul>
                    </div>
                </div>
                <div className="user_main">
                ...
                <div  ref="JtGamersLi" style={{overflow:'scroll',width:'100%'}}>
